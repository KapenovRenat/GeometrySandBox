...
#define UE_PROJECT_NAME GeometrySandBox
#define UE_TARGET_NAME GeometrySandBoxEditor
#define UE_MODULE_NAME "GeometrySandBox"
...
#define GEOMETRYSANDBOX_API DLLEXPORT
